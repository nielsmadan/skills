...
Opinionated agent skills for code review, research, and daily workflow. 49 skills, generated from
...
| `breakdown-milestone` | Break a milestone (e.g. M0) into incremental sprints of working software. Triggers "breakdown milestone", "split milestone", "plan milestone", "sprint plan for MX". |
| `breakdown-sprint` | Break a sprint (e.g. s1) into ordered, parallelizable tasks following agile user-story principles. Triggers "breakdown sprint", "task breakdown", "plan sprint tasks". |
